...
export const functions: FunctionDefinition[] = [
  ...
  read("email unsubscribes", "query_unsubscribed_emails", "email.unsubscribes", "/email/unsubscribes", [s("start_date"), s("end_date"), n("limit"), n("offset"), { ...s("sort_direction"), choices: ["asc", "desc"] }, s("email")], { atLeastOne: [["end_date", "email"]] }),
  read("email hard-bounces", "query_hard_bounced_emails", "email.hard_bounces", "/email/hard_bounces", [s("start_date"), s("end_date"), n("limit"), n("offset"), s("email")], { atLeastOne: [["end_date", "email"]] }),
  write("email status", "change_email_subscription_status", "email.status", "/email/status", [a("email", true), { ...s("subscription_state", true), choices: ["subscribed", "unsubscribed"] }]),
